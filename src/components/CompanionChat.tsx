...
export function CompanionLair({ onClose }: Props) {
  ...
  }, []); // Зависимости пусты, чтобы сработало при открытии
