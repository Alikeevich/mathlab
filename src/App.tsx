...
// ИКОНКИ (Добавил Shield для админа)
...
import { AdminDashboard } from './components/AdminDashboard'; // Импорт Админ-центра
...
function MainApp() {
  ...
  const [showAdminDashboard, setShowAdminDashboard] = useState(false); // <--- Стейт для Админки
